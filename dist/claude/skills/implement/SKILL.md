...
`trailhead/refs/trail-metadata.md`) before building. Then register the plan's task ids
...
`review`. All gates green: a good point to clear/restart — the stamped `tasks:` field
